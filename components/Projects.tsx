...
const Projects = () => {
  ...
  const currentProject = projectData.find((project) => project.id === inProjectView);
  useEffect(() => {
  ...
  return (
    <div className="max-w-6xl px-4 mx-auto">
      <h1 className="text-center font-bold uppercase text-6xl leading-loose">Projects</h1>
      <div ref={scope}>
        {currentProject && (
          <ProjectDetail
